...
// 使用 opensource 作 key，加密 opensource 得出
#define AES_ENCRYPT_KEY  [NSData dataWithBytes:(uint8_t[]){0xce, 0xaa, 0x5b, 0x73, 0x9e, 0x39, 0x45, 0xfd, 0x2f, 0xa2, 0x96, 0x50, 0x54, 0x41, 0x5d, 0x87} length:16]


#define kSinaFlag				@"sina"
#define	kNotSinaFlag			@"other"
#define kTencentFlag			@"tencent"


// 新浪
#define SHKSinaConsumerKey      @""           //申请获得的原始ConsumerKey
#define SHKSinaSecret			@""           //申请获得的原始Secret
//#define SHKSinaConsumerKey    [NSData data] //加密后的ConsumerKey
//#define SHKSinaSecret         [NSData data] //加密后的Secret

#define SINA_RequestURL			@"http://api.t.sina.com.cn/oauth/request_token" //获取未授权request token
#define SINA_AuthorizeURL		@"http://api.t.sina.com.cn/oauth/authorize"  //获取授权request token
#define SINA_AccessURL			@"http://api.t.sina.com.cn/oauth/access_token"  //获取access token
#define SINA_AccountURL         @"http://api.t.sina.com.cn/users/show"


// 豆瓣
#define DOUBAN_APPKEY			@""
#define DOUBAN_APPSECRET		@""
//#define DOUBAN_APPKEY			[NSData data]
//#define DOUBAN_APPSECRET		[NSData data]



#define DOUBAN_RequestURL		@"http://www.douban.com/service/auth/request_token"
#define DOUBAN_AuthorizeURL		@"http://www.douban.com/service/auth/authorize"
#define DOUBAN_AccessURL		@"http://www.douban.com/service/auth/access_token"
#define DOUBAN_AccountURL       @"http://api.douban.com/people"

#define NONCE_LENGTH_FOR_TENCENT 32

//Below is the app key and secret for tencent test, this has write access
#define QQ_APPKEY               @""
#define QQ_APPSECRET            @""
//#define QQ_APPKEY               [NSData data]
//#define QQ_APPSECRET            [NSData data]

#define QQ_RequestURL		@"https://open.t.qq.com/cgi-bin/request_token"
#define QQ_AuthorizeURL		@"https://open.t.qq.com/cgi-bin/authorize"
#define QQ_AccessURL		@"https://open.t.qq.com/cgi-bin/access_token"
#define QQ_AccountURL       @"http://open.t.qq.com/api/user/info"

#define RENREN_APIKEY		@""
#define RENREN_SECRET		@""

#define SHKRenRenSessionProxyURL  @""
#define SHKRenRenUseSessionProxy  NO 

#define CallBackURL @"open://www.open.com"  //回调url

#define SERVICE_AUTHORIZED @"SERVICE_AUTHORIZED"
